...
const Home = () => {
    ...
    const checkoutHandler = async (amount) => {
        ...
        const options = {
            ...
            amount: order.amount,
            currency: "INR",
            name: "Anand Programmer",
            description: "Tutorial of RazorPay",
            image: "https://images.pexels.com/photos/19740693/pexels-photo-19740693/free-photo-of-me.png?auto=compress&cs=tinysrgb&w=600&lazy=load",
            order_id: order.id,
            callback_url: "http://localhost:8000/api/paymentverification",
            prefill: {
                name: "Anand Yadav",
                email: "anandyadav@example.com",
                contact: "9999999999"
            },
            notes: {
